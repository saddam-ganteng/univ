        ...
        <form action="/daftar/proses" method="post">
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input type="text" name="nama_lengkap" class="w-full rounded-lg border border-stone-300 px-4 py-2"
                        required>
                </div>
                <div>
                    <label class="block text-stone-700 font-medium mb-1">Email</label>
                    <input type="email" name="email" class="w-full rounded-lg border border-stone-300 px-4 py-2"
                        required>
                </div>
                <div>
                    <label class="block text-stone-700 font-medium mb-1">Fakultas Pilihan</label>
                    <select name="fakultas_dipilih" class="w-full rounded-lg border border-stone-300 px-4 py-2"
                        required>
